...
#b.attach_kretprobe(event="update_process_times",fn_name="byebye")
b.attach_kretprobe(event="tick_periodic",fn_name="byebye")
...
while 1:
    try:
        ...
        continue
    print("%-18.9f %-16s %-6d cpu:%-3d %s" % (ts, task, pid, cpu, msg))
